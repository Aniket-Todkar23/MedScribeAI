...
class Qwen2VLServer:
    ...
    def serve(self):
        ...
        DEFAULT_SYSTEM_PROMPT = (
            "You are a medical document analysis specialist. This system ONLY supports "
            "Lab Reports and Prescriptions. You extract ALL information from these documents "
            "— including patient demographics, facility details, physician info, test results, "
            "and medication details. You preserve all numerical values, units, reference ranges, "
            "and flags exactly as shown. You NEVER skip header/footer information."
        )
        ...
        DEFAULT_USER_PROMPT = (
            ...
            "| Field | Value |\n"
            "| --- | --- |\n"
            "| Document Type | lab_report / prescription |\n"
            "| Lab/Facility Name | ... |\n"
            "| Facility Address | ... |\n"
            "| Report Date | ... |\n"
            ...
            "## SECTION 4: CLINICAL DATA — Extract Tests or Medications\n"
            "If this is a LAB REPORT, for each test panel (e.g., CBC, Lipid Profile), create a section with a table:\n"
            "| Test Name | Result | Unit | Reference Range | Flag |\n"
            "| --- | --- | --- | --- | --- |\n\n"
            "Flag rules: Compare result to reference range and mark:\n"
            "- ⬆ if result is ABOVE the upper limit\n"
            "- ⬇ if result is BELOW the lower limit\n"
            "- ⚠ if result is critically abnormal\n"
            "- Leave Flag empty if normal\n\n"
            "If this is a PRESCRIPTION, create a section called '### Medications' with a table:\n"
            "| Medication | Strength | Quantity | Instructions | Refills | DAW |\n"
            "| --- | --- | --- | --- | --- | --- |\n"
            "Extract drug names, strengths, exact dispensing quantities, directions/Sig, number of refills, "
            "and DAW (Dispense As Written) preference directly from the document.\n\n"
            "## SECTION 5: SUMMARY OF ABNORMAL FINDINGS (Lab Reports only)\n"
