      ...
      >
        ...
        <button
          ...
          style={{
            ...
            boxShadow: '0 2px 8px rgba(31, 159, 163, 0.2)',
            padding: '0',
            outline: 'none'
          }}
          onMouseEnter={(e) => {
          ...
          onMouseLeave={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 2px 8px rgba(31, 159, 163, 0.2)';
          }}
        >
          {sidebarCollapsed ? <ChevronsRight size={20} strokeWidth={2.5} /> : <ChevronsLeft size={20} strokeWidth={2.5} />}
        </button>
        ...
        >
          {aiPanelCollapsed ? <ChevronsLeft size={20} strokeWidth={2.5} /> : <ChevronsRight size={20} strokeWidth={2.5} />}
        </button>

        <div className="flex items-center gap-3" style={{ marginLeft: '48px' }}>
          <Activity size={24} color="var(--color-primary)" />
          <span className="font-bold" style={{ fontSize: 'var(--text-h4)', color: 'var(--color-primary-dark)' }}>
            Diagnostic-IQ
          </span>
          <span style={{ color: 'var(--color-border)', margin: '0 var(--space-2)' }}>/</span>
          <div className="flex items-center gap-2 text-sm text-muted">
            <Home size={14} />
            <span>Dashboard</span>
            <span style={{ color: 'var(--color-border)' }}>/</span>
            <span className="text-primary font-medium">Patient Analytics</span>
          </div>
        </div>
        <div className="flex items-center gap-3" style={{ marginRight: '48px' }}>
          <span className="badge badge-teal">Dr. Hambire</span>
